...
export const tr: Record<CopyKey, string> = {
  ...
  tariffPoolAsk: 'Bu tarife aynı otoparka park eden sürücülere önerilsin mi? Onlarınki de aynı yoldan sana döner. Giden şey bir yerin fiyatı, sana ait bir şey değil.',
  tariffPoolShare: 'Paylaş',
  tariffPoolKeep: 'Bende kalsın',
