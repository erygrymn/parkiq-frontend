...
export const en = {
  ...
  findParkingPro: 'Nearby parking and chargers in Pro',
  ...
  proFeatureFind: 'Find nearby parking and chargers',
  ...
  proFeatureVehicles: 'Multiple vehicles',
  planYearly: 'Yearly',
  planMonthly: 'Monthly',
  ...
  vehicles: 'Vehicles',
  vehicleNamePlaceholder: 'Add a vehicle',
  multiVehiclePro: 'Multiple vehicles in Pro',
