...
export const en = {
  ...
  reminderKind: 'How to alert me',
  kindNotification: 'Notification',
  kindAlarm: 'Sound',
  kindBoth: 'Both',
  kindHint: 'Sound breaks through Focus modes. A true alarm that rings on silent needs iOS 26.',
  reminderNeedsTariff: 'This needs a tariff — add one first',
  reminderOff: 'Off',
  hoursShort: '{hours} h',
  ...
  tariffPoolAsk: 'Share this tariff with drivers who park at the same car park? Theirs comes back to you the same way. What travels is the price of a place, not anything about you.',
  tariffPoolShare: 'Share it',
  tariffPoolKeep: 'Keep it to myself',
